...
start.bat
```
File script này sẽ tự động khởi động các container Docker Compose ngầm, đồng thời tạo ra một Cloudflare Tunnel ánh xạ API Gateway (`http://localhost:5000`) ra internet thông qua tunnel tên `beaverdash-backend` để liên kết bên ngoài.
